...
if operacion == "+":
    print("\nLa suma de los dos numeros introducidos es: " + str(suma))

elif operacion == "-":
    print("\nLa resta de los dos numeros introducidos es: " + str(resta))

elif operacion == "*":
    print("\nLa multiplicacion de los dos numeros introducidos es: " + str(multiplicacion))

elif operacion == "/":
    print("\nLa division de los dos numeros introducidos es: " + str(division))
